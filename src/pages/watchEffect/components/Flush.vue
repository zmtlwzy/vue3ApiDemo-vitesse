<template>
  <n-card :title="$options.name">
    <n-space vertical align="center">
      <p>open console</p>
      <des-table ref="el" :var-obj="{ count, count2, other }" />
      <br>
      <n-button type="primary" @click="add">
        add
      </n-button>

      <n-radio-group v-model:value="mode" class="mt-5" name="watchEffectFlush">
...
<script lang="ts">
import type { ComponentPublicInstance, WatchOptionsBase, WatchStopHandle } from 'vue'
